        ...
        <div className="section-container" style={{ position: 'relative', zIndex: 1 }}>
          <motion.div {...fadeUp(0.1)}>
            ...
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '1rem', color: 'rgba(255,255,255,0.65)', maxWidth: '560px', lineHeight: 1.85 }}>
              {t("2026–2027 akademik yılı eğitim ücretleri ve ödeme seçenekleri.")}
            </p>
          </motion.div>
        </div>
      </div>
          ...
          <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
            <motion.div {...fadeUp(0)}>
              ...
              <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: '2rem', fontWeight: 700, color: 'var(--primary)', marginBottom: '1.25rem' }}>
                {t("Ücret Bilgileri Güncelleniyor")}
              </h2>
              <p style={{ fontFamily: 'var(--font-sans)', fontSize: '1.05rem', color: 'var(--text-mid)', lineHeight: 1.9, marginBottom: '2rem', maxWidth: '580px', margin: '0 auto 2rem' }}>
                {t("2026–2027 akademik yılına ait eğitim ücretleri ve ödeme planları en kısa sürede bu sayfada yayımlanacaktır. Detaylı bilgi almak için Mali İşler birimimizle iletişime geçebilirsiniz.")}
              </p>
            </motion.div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.25rem', marginTop: '3rem' }} className="ucret-grid">
                {[
                  ...
                  <div key={t(item.title)} style={{
                    ...
                    <h3 style={{ fontFamily: 'var(--font-serif)', fontSize: '1rem', fontWeight: 700, color: 'var(--primary)', marginBottom: '0.4rem' }}>{t(item.title)}</h3>
            ...
            <motion.div {...fadeUp(0.15)} style={{ marginTop: '3.5rem' }}>
              <div style={{
                ...
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontFamily: 'var(--font-sans)', fontSize: '0.88rem', color: 'var(--text-mid)', marginBottom: '0.3rem' }}>{t("Mali İşler İletişim")}</div>
                ...
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontFamily: 'var(--font-sans)', fontSize: '0.88rem', color: 'var(--text-mid)', marginBottom: '0.3rem' }}>{t("E-posta")}</div>
