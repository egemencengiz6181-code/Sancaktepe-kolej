        ...
        <div className="section-container" style={{ position: 'relative', zIndex: 1 }}>
          <motion.div {...fadeUp(0.1)}>
            ...
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '1rem', color: 'rgba(255,255,255,0.65)', maxWidth: '560px', lineHeight: 1.85 }}>
              {t("Kolej Sancaktepe Ortaokulu 5, 6, 7 ve 8. sınıf kayıt süreçleri.")}
            </p>
          </motion.div>
        </div>
      </div>
        ...
        <div className="section-container">
          ...
          <motion.div {...fadeUp(0)}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.75rem' }}>
              ...
              <span className="section-tag">{t("5. Sınıf")}</span>
            </div>
            <h2 className="section-title" style={{ marginBottom: '2rem' }}>{t("5. Sınıf Kayıt Süreci")}</h2>
          </motion.div>
          ...
          <motion.div {...fadeUp(0.05)}>
            <div style={{
              ...
              <P>{t("5. sınıfa başvuran aday öğrenciler için herhangi bir sınav uygulanmaz. Başvuru formu doldurma sırası göz önünde bulundurularak kontenjan dahilinde aday öğrenciler Aday Tanıma Çalışması'na davet edilir.")}</P>
              <P>{t("Aday Öğrenci Tanıma Çalışması, öğrencinin sosyal, bireysel ve akademik becerilerini sınıf ve branş öğretmenlerinin gözlemlemesi amacıyla tasarlanmıştır. Süreç, farklı ders öğretmenleri ve PDR uzmanı tarafından gerçekleştirilen değerlendirme görüşmesiyle son bulur.")}</P>
              <P>{t("Süreçlerin tümünü olumlu tamamlayan aday öğrencilerle kontenjan doğrultusunda kesin kayıt yapılır.")}</P>
              <div style={{
                ...
                <strong>{t("Not:")}</strong> {t("5. sınıf için başarı bursu süreci uygulanmaz.")}
              </div>
            </div>
          </motion.div>
          ...
          <motion.div {...fadeUp(0.08)}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.75rem' }}>
              <div className="red-line" />
              <span className="section-tag">{t("6, 7 ve 8. Sınıf")}</span>
            </div>
            <h2 className="section-title" style={{ marginBottom: '2rem' }}>{t("6-7-8. Sınıf Kayıt Süreci")}</h2>
          </motion.div>
          ...
          <motion.div {...fadeUp(0.1)}>
            <div style={{
              ...
              <P>{t("6, 7 ve 8. sınıfa başvuran aday öğrenciler TED Okulları Giriş Sınavı'na (TOGS) alınır. TOGS, Türkçe, Matematik, Fen Bilimleri, Sosyal Bilgiler ve İngilizce sorularından oluşur. Sınav her yıl Kasım, Ocak ve Mart aylarında uygulanır; sonuçlar aynı gün açıklanır.")}</P>
              <P>{t("TOGS'ta belirlenen taban puanı sağlayan adaylar İngilizce sınavına ve Aday Tanıma Çalışması'na davet edilir.")}</P>
              <P>{t("Sınav sonuçları, İngilizce sınav notu ve Aday Tanıma Çalışması değerlendirmeleri bir araya getirilerek puan sıralaması oluşturulur. Kontenjan dahilinde kesin kayıt süreçleri yürütülür.")}</P>
              <div style={{
                background: 'rgba(35,46,92,0.05)', borderRadius: '10px', padding: '1rem 1.25rem', marginTop: '0.5rem',
                fontFamily: 'var(--font-sans)', fontSize: '0.85rem', color: 'var(--text-mid)', lineHeight: 1.75,
              }}>
                <strong>{t("Not:")}</strong> {t("Ortaokul kademesinde başarı bursu süreci uygulanmaz.")}
              </div>
            </div>
          </motion.div>
