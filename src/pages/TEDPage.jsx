  ...
  return (
    <>
      ...
      <div className="page-hero" style={{
        backgroundImage: 'linear-gradient(135deg, rgba(26,35,71,0.93) 0%, rgba(35,46,92,0.89) 55%, rgba(46,61,122,0.89) 100%), url(\'/gallery/ilkokul/21.jpg\')',
        ...
        <div className="section-container" style={{ position: 'relative', zIndex: 1 }}>
          <motion.div {...fadeUp(0.1)}>
            ...
            <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(2.2rem, 4.5vw, 3.6rem)', fontWeight: 700, color: '#fff', lineHeight: 1.12, marginBottom: '1rem' }}>
              {t("Türk Eğitim Derneği")}
            </h1>
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '1rem', color: 'rgba(255,255,255,0.65)', maxWidth: '560px', lineHeight: 1.85 }}>
              {t("Cumhuriyetin kuruluşuyla birlikte doğan, 1928'den bu yana eğitimi yükseltmek için çalışan köklü bir sivil toplum kuruluşu.")}
            </p>
          </motion.div>
        </div>
      </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '5rem', alignItems: 'start' }} className="ted-grid">
            ...
            <motion.div {...fadeUp(0)}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem' }}>
                ...
                <span className="section-tag">{t("Tarihçe")}</span>
              </div>
              <div style={{
            ...
            <motion.div {...fadeUp(0.15)}>
              <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(1.6rem, 3vw, 2.4rem)', fontWeight: 700, color: 'var(--primary)', lineHeight: 1.25, marginBottom: '1.75rem' }}>
                {t("Atatürk'ün Çağrısıyla")}<br /><span style={{ color: 'var(--red)' }}>{t("Kurulan Dernek")}</span>
              </h2>
              {[
                ...
                <p key={i} style={{ fontFamily: 'var(--font-sans)', fontSize: '1rem', color: 'var(--text-mid)', lineHeight: 1.9, marginBottom: '1.25rem' }}>{t(p)}</p>
              ))}
            </motion.div>
          </div>
        </div>
        ...
        <div className="section-container">
          <motion.div {...fadeUp(0)} style={{ textAlign: 'center', marginBottom: '4rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', justifyContent: 'center', marginBottom: '0.75rem' }}>
              <div className="red-line" />
              <span className="section-tag">{t("Misyon")}</span>
              <div className="red-line" />
            </div>
            <h2 className="section-title" style={{ textAlign: 'center' }}>{t("TED'in")} <span>{t("Misyonu")}</span></h2>
          </motion.div>
      ...
      <section style={{ padding: '7rem 0', background: 'var(--off-white)', position: 'relative' }}>
        <div className="section-container">
          <motion.div {...fadeUp(0)} style={{ textAlign: 'center', marginBottom: '4rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', justifyContent: 'center', marginBottom: '0.75rem' }}>
              <div className="red-line" />
              <span className="section-tag">{t("Okullar")}</span>
              <div className="red-line" />
            </div>
            <h2 className="section-title" style={{ textAlign: 'center' }}>{t("TED Neden")} <span>{t("Okul Açar?")}</span></h2>
          </motion.div>
          ...
          <div style={{ maxWidth: '860px', margin: '0 auto' }}>
            <motion.div {...fadeUp(0.1)}>
              <p style={{ fontFamily: 'var(--font-sans)', fontSize: '1rem', color: 'var(--text-mid)', lineHeight: 1.9, marginBottom: '2.5rem', textAlign: 'center' }}>
                {t("Türk Eğitim Derneği, eğitimin bir ülkenin ekonomik ve sosyal kalkınmasındaki en önemli etken olduğuna inanır ve bu doğrultuda okullar açar.")}
              </p>
            </motion.div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.5rem' }} className="ted-why-grid">
              {[
                ...
                <motion.div key={t(item.title)} {...fadeUp(i * 0.1)}>
                  <div style={{
                  ...
                  >
                    ...
                    <h3 style={{ fontFamily: 'var(--font-serif)', fontSize: '1rem', fontWeight: 700, color: 'var(--primary)', marginBottom: '0.65rem' }}>{t(item.title)}</h3>
                    <p style={{ fontFamily: 'var(--font-sans)', fontSize: '0.88rem', color: 'var(--text-mid)', lineHeight: 1.75 }}>{t(item.desc)}</p>
                  </div>
                </motion.div>
              ))}
            </div>
