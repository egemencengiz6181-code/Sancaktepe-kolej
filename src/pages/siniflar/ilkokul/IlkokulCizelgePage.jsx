...
export default function IlkokulCizelgePage() {
  return (
    <>
        ...
        <div className="section-container">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.65 }} style={{ maxWidth: '580px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', color: 'var(--text-mid)', lineHeight: 1.9, marginBottom: '2rem' }}>
              İlkokul haftalık zaman çizelgesi yeni dönem başlamadan önce bu sayfada yayımlanacaktır. Detaylı bilgi için kayıt ofisimizle iletişime geçebilirsiniz.
            </p>
            <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <Link to="/siniflar/ilkokul" style={{ fontFamily: 'var(--font-display)', fontSize: '0.7rem', fontWeight: 800, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--primary)', border: '2px solid var(--primary)', padding: '0.85rem 2rem', borderRadius: '5px', textDecoration: 'none' }}>İlkokul Sayfası ←</Link>
            </div>
          </motion.div>
        </div>
      </section>
